...
def solve_C_v2_MMS(Ntot,delta_t,time_iter,stationnary): #stationnary = Bool
    ...
    #print(my_M)
    return the_C
my_C_MMS_stationnaire = solve_C_v2_MMS(1000,0.001,5,True)
my_C_MMS_instationnaire = solve_C_v2_MMS(1000,0.001,5,False)
...
for Ntot in list_ntot:
	radii = np.linspace(0,R,Ntot)	
	my_C = solve_C_v2_MMS(Ntot,0.0001,5,False)
...
#list_dts = [0.0001,0.0002,0.0004,0.0008,0.00016]
list_dts = [0.001,0.002,0.004,0.008,0.016]
erreurs_11 = []
erreurs_22 = []
erreurs_33 = []
Ntot_1 = 1000
...
#time_iter_min = Ttot_1/delta_t_min
u_anal_2 = z_MMS[:,1]
#radii2 = np.linspace(0,R,Ntot_2)


for delta_t in list_dts:
	time_iter = Ttot_1/delta_t
	my_C = solve_C_v2_MMS(Ntot_1,delta_t,time_iter,False)
	err11 = erreur_L1_MMS(my_C,u_anal_2,Ntot_1)
	err22 = erreur_L2_MMS(my_C,u_anal_2,Ntot_1)
	err33 = erreur_inf_MMS(my_C,u_anal_2,Ntot_1)
...
#print(my_C)
plt.figure()
plt.plot(radii,my_C_MMS_stationnaire,label = 'solution numérique en stationnaire')
plt.plot(radii,my_C_MMS_instationnaire,label = 'solution numérique en instationnaire ')
plt.xlabel('radius`[m]')
plt.ylabel('erreurs [-]')
